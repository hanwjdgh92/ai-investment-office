...
# ponytail: 매시간 도는 run_price_update.ps1과 같은 data/*.json·office/index.html을 동시에 쓰지 않도록,
# 실행 중 락 파일을 남긴다(run_price_update.ps1이 이 파일을 보고 그 회차를 건너뜀).
$LockFile = Join-Path $LogsDir ".scheduled_analysis.lock"
